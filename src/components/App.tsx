...
export default function App({ name, icon: Icon, color, colorHover }: Props) {
  ...
  return (
    <button
      onClick={() => play()}
      className="hoverable flex flex-col w-full sm:min-w-32 p-4 rounded-lg gap-3 items-center justify-center group hover:bg-[#f2f2f2] cursor-none hover:scale-102 transition
